...
namespace BuPazardanAl.Business.Abstract
{
    public interface IAuthService
    {
        ...
        public async Task<IdentityResult> CustomerRegister(CustomerRegisterDto customerRegisterDto)
        {
            ...
            var customer = new Customer { CityId = customerRegisterDto.CityId, FirstName = customerRegisterDto.FirstName, LastName = customerRegisterDto.LastName, PhoneNumber = customerRegisterDto.PhoneNumber, Status = true };
        ...
        public async Task<IdentityResult> SellerRegister(SellerRegisterDto sellerRegisterDto)
        {
            ...
            {
                StoreName = sellerRegisterDto.SellerName,
